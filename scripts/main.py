...
=======
import sys
>>>>>>> aec481c7db1bbc3e58754d4493573c88885bfa7c
import cv2
import numpy as np
import os
import math
...
from source.foot_reconstruction import get_focal_length, cut_visual_hull, cloud,\
                                       surface_cloud, parameters
...
if __name__ == "__main__":
    ...
    if type == "photo":
        ...
        for i, filename in enumerate(glob.iglob(path)):
            ...
            paper_points, foot_segmented, last_angle01, last_angle23 = extract_metrics(image, i, last_angle01, last_angle23)
